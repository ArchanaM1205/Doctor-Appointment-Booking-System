...
<body>
  ...
  <div class="contact-content">
    ...
    <div class="contact-image">
      <img src="contact_image.png" alt="Contact" />
    </div>
    ...
    <div class="contact-info">
      <div>
        <h2>Address</h2>
        <p>123 Medical Lane, Health City, Wellness State, 56789</p>
      </div>
      <div>
        <h2>Phone</h2>
        <p>+91 98765 43210</p>
      ...
      <!-- Button -->
      <button class="contact-btn" onclick="goHome()">
        Explore Now
        <img src="arrow_icon.svg" alt="arrow" />
      </button>
    </div>
  </div>
</div>
